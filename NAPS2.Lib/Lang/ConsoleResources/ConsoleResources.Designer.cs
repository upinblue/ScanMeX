...
namespace NAPS2.Lang.ConsoleResources {
    ...
    internal class ConsoleResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The page size could not be parsed..
        /// </summary>
        internal static string CouldntParsePageSize {
            get {
                return ResourceManager.GetString("CouldntParsePageSize", resourceCulture);
            }
        }
