...
public class GtkDesktopForm : DesktopForm
{
    ...
    public GtkDesktopForm(
        ...
        NAPS2.PostScan.DocumentEditor documentEditor)
        : base(config, keyboardShortcuts, notificationManager, cultureHelper, colorScheme, profileManager, imageList,
            ...
            imageListViewBehavior, desktopFormProvider, desktopSubFormController, commands, sidebar, documentPanel,
            iconProvider, documentUploadController, documentQueue, sectionBuilder, documentEditor)
    {
