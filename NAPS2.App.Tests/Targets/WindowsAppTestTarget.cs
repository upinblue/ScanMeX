...
public class WindowsAppTestTarget : IAppTestTarget
{
    ...
    public AppTestExe Gui => GetAppTestExe("NAPS2.App.WinForms", "ScanMe.exe", "win-x64");
    public AppTestExe Worker => GetAppTestExe("NAPS2.App.Worker", "NAPS2.Worker.exe", "win-x86", null, "lib");
    public AppTestExe Server => GetAppTestExe("NAPS2.App.WinForms", "ScanMe.exe", "win-x64", "server");
